...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: plum;\n}", "",{"version":3,"sources":["webpack://./src/main.scss"],"names":[],"mappings":"AAEA;EACE,sBAHW;AAEb","sourcesContent":["$body-color: plum;\n\nbody {\n  background-color: $body-color;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _src_main_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/main.scss */ "./src/main.scss");
/* harmony import */ var _Users_arseniinetrebenko_Documents_Programming_Cursor_Homework_03_Functions_js_script__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../03_Functions/js/script */ "../03_Functions/js/script.js");
...
var button = document.querySelector('#getMaxDigitButton');
button.addEventListener('click', function () {
  console.log('Max digit:');
  console.log((0,_Users_arseniinetrebenko_Documents_Programming_Cursor_Homework_03_Functions_js_script__WEBPACK_IMPORTED_MODULE_2__.default)(Math.random()));
});
console.log(button);
console.log((0,_js_module__WEBPACK_IMPORTED_MODULE_0__.default)(item.name));
console.log((0,_Users_arseniinetrebenko_Documents_Programming_Cursor_Homework_03_Functions_js_script__WEBPACK_IMPORTED_MODULE_2__.default)(1234));
})();
